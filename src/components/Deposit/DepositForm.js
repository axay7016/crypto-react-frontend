        ...
        <div className="row">
          <div className="col-xxl-8 col-xl-7">
            <div className="right-area">
              <p className="para-area p-text">Deposit your amount</p>
              ...
              <div className="address-bar">
                {PaymentForm ? (
                  ...
                  <form action="#">
                    <div className="col-6 deposit-usd">
                    ...
                    {Network ? <div className="col-6 deposit-usd">
                      <div className="input-single">
                    ...
                    <span className="btn-border despoti-bt">
                      {isLoading ? (
                        <Loader />
                      ) : (
                        <button
